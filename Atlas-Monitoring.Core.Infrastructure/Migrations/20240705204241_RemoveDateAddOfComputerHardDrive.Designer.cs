...
namespace Atlas_Monitoring.Core.Infrastructure.Migrations
{
    ...
    [Migration("20240705204241_RemoveDateAddOfComputerHardDrive")]
    partial class RemoveDateAddOfComputerHardDrive
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Atlas_Monitoring.Core.Models.Database.Device", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 7, 5, 22, 42, 41, 10, DateTimeKind.Local).AddTicks(6074));

                    b.Property<DateTime>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 7, 5, 22, 42, 41, 10, DateTimeKind.Local).AddTicks(6303));
