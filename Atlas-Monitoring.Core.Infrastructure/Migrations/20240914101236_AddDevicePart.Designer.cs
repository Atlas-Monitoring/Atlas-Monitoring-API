...
namespace Atlas_Monitoring.Core.Infrastructure.Migrations
{
    ...
    [Migration("20240914101236_AddDevicePart")]
    partial class AddDevicePart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Atlas_Monitoring.Core.Models.Database.Device", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 9, 14, 12, 12, 35, 554, DateTimeKind.Local).AddTicks(9153));

                    b.Property<DateTime>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 9, 14, 12, 12, 35, 554, DateTimeKind.Local).AddTicks(9462));
