...
namespace Atlas_Monitoring.Core.Infrastructure.Migrations
{
    ...
    [Migration("20240914103935_AddModelAndManufacturerDevice")]
    partial class AddModelAndManufacturerDevice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Atlas_Monitoring.Core.Models.Database.Device", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 9, 14, 12, 39, 34, 924, DateTimeKind.Local).AddTicks(3348));

                    b.Property<DateTime>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 9, 14, 12, 39, 34, 924, DateTimeKind.Local).AddTicks(3570));
