...
namespace Atlas_Monitoring.Core.Infrastructure.Migrations
{
    ...
    [Migration("20240710000534_AddPropertiesToComputerHardDriveObject")]
    partial class AddPropertiesToComputerHardDriveObject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Atlas_Monitoring.Core.Models.Database.Device", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 7, 10, 2, 5, 34, 468, DateTimeKind.Local).AddTicks(4998));

                    b.Property<DateTime>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 7, 10, 2, 5, 34, 468, DateTimeKind.Local).AddTicks(5235));
